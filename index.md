...
# Project Files (One Artifact for all three categories)
...
- These files are in a separate repository called "AndroidStudio", under my "sourkrouse" GitHub site.
...
Building this project helped to solidify my career goal decision in software development or engineering. I enjoyed learning the fundamentals of a mobile application and hope to apply those skills in my current and future positions. I feel confident I will be able to move up or change roles in my company.
